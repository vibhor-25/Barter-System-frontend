...
return (
        //<div className='flex justify-center gap-5 flex-wrap my-10 p-5 mx-20 rounded-lg shadow-lg'>
                ...
                <div key={product.id} className="card w-80 max-w-[25%] flex-shrink-0 h-100 bg-[#E3FFC9] p-1 rounded-2xl flex flex-col gap-3 items-center shadow-md hover:scale-102 hover:-translate-y-2 transition-transform duration-300">
