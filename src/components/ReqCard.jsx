...
return (
                ...
                <div key={product.id} className="card w-80 max-w-[25%] flex-shrink-0 h-auto bg-[var(--accent-v-light-blue,rgba(237,244,255,1))] p-1 rounded-2xl flex flex-col gap-3 items-start shadow-md hover:scale-102 hover:-translate-y-2 transition-transform duration-300">
                    ...
                    <h3 className='text-[#1C3700] font-Inter font-semibold text-2xl pl-2'>{product.title}</h3>
                    <p className='text-[#1C3700] font-InriaSans text-0.5xl pl-2 pr-2'>{product.desc}</p>
