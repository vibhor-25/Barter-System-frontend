...
const ReqCard = ({product}) => {
  ...
  return (
    <div key={product.itemId} className="card w-80 max-w-[25%] shrink-0 h-auto bg-(--accent-v-light-blue,rgba(237,244,255,1)) p-1 rounded-2xl flex flex-col gap-3 items-start shadow-md hover:scale-102 hover:-translate-y-2 transition-transform duration-300">
